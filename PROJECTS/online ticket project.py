...
murugesh=mysql.connector.connect(
    ...
    user="root",
    password="12345",
    database="online_tickrt_booking"
)
mycursor=murugesh.cursor()
# mycursor.execute("create database online_tickrt_booking")
# mycursor.execute("create table tickets_details (Name varchar(225),Phone_No int ,From_loc varchar(225),To_loc varchar(225),Tickets int,Price int)")
# murugesh.commit()
# print("success")
